...
SELECT v.registration_area,
       ...
       COUNT(DISTINCT e.patient_id) FILTER (WHERE ec.adrg = 'F62' AND e.principal_diagnosis IN ('I11.0','I13.0','I13.2','I50.0', 'I50.1','I50.9','R57.9','R57.0')) AS F62,
       COUNT(DISTINCT e.patient_id) FILTER (WHERE ec.adrg = 'L60' AND e.principal_diagnosis IN ('I12.0','I13.1','N18.4','N18.5','N19','R34')) AS L60,
       COUNT(DISTINCT e.patient_id) FILTER (WHERE ec.adrg = 'L67' AND e.principal_diagnosis = 'I12.9') AS L67,
       COUNT(DISTINCT e.patient_id) FILTER (WHERE ec.adrg = 'B69' AND e.principal_diagnosis IN ('G45.1','G45.2','G45.8', 'G45.9','G46.0','G46.1', 'G46.2,I65.0','I65.1','I65.2','I65.3','I65.8','I65.9')) AS B69,
